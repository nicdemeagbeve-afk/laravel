...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600">Mettez à jour les informations du technicien</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
        <form action="{{ route('techniciens.update', $technicien) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    @if($technicien->photo)
                        <div class="mb-3">
                            ...
                            <img src="/storage/{{ $technicien->photo }}" alt="{{ $technicien->nom }}" class="w-24 h-24 rounded-lg object-cover">
                        </div>
                    @endif
